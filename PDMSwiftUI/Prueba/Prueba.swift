...
//  PDMSwiftUI
//
//  Created by Angel Hernández on 11/25/20.
//

import Foundation
protocol ItemStoring {
    associatedtype TipoDato
    
    var items:[TipoDato] {get set}
    mutating func add(item: TipoDato)
}
...
struct Prueba: ItemStoring {
    var items = [Int]()
}

struct Prueba2: ItemStoring {
    var items = [NSObject]()
}
